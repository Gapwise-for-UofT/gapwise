...
export function parseIcs(
  ...
  for (const ev of events) {
    ...
    if (!rawLoc || /TBA|online|virtuel|remote/i.test(rawLoc)) {
      locationKind = /online|virtuel|remote/i.test(rawLoc) ? "online" : "tba";
    }
